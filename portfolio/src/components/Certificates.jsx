      ...
      <div className="container">
        <div className="section-header reveal">
          ...
          <p className="section-subtitle">
            Sertifikat yang saya peroleh dari kegiatan akademik dan kursus online.
          </p>
        </div>

        <div className="certificates-grid">
          {certificates.map((cert, i) => (
            <div key={cert.id} className={`cert-card card reveal reveal-delay-${i + 1}`}>
        ...
        <div className="cert-cta reveal reveal-delay-3">
          ...
          <div>
            ...
            <p>Saya selalu berusaha meningkatkan kemampuan melalui kursus, workshop, dan pengalaman nyata.</p>
          </div>
          <a
